...
if($number!=0){
    ?>
    <h2 align="center">Data of Passenger</h2>
    <center>
    <table border="2px" cellspacing="6" width="90%">
        <tr>
        <th width="3%">S.N</th>
  ...
  while($tab=mysqli_fetch_assoc($ans))
  {
    ...
    <td><a href='update.php?sn=$tab[SN]' ><button class='update'>Edit</button></a>
    <a href='delete.php?sn=$tab[SN]' ><button class='delete' onclick='return checkdelete()'>Remove</button></a></td>
