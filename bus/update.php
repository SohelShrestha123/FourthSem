...
$a=$_GET['sn'];
$query="SELECT * FROM passenger where SN='$a'";
...
$ans=mysqli_query($conn,"UPDATE passenger SET Firstname='$first' ,Lastname='$last',Username='$userName',Address='$place',Email='$email',
Phone_No='$phone',New_Password=md5('$new'),Password=md5('$cpass'),Gender='$gender' WHERE SN='$a'");
